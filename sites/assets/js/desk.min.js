...
frappe.ui.Page = Class.extend({
	...
	add_inner_button: function add_inner_button(label, action, group) {
		...
		if (group) {
			...
			return $('<button class="btn btn-default btn-xs" style="margin-left: 10px;">' + __(label) + '</btn>').on("click", _action).appendTo(this.inner_toolbar.removeClass("hide"));
		}
	},
...
frappe.search.SearchDialog = Class.extend({
	...
	searches: {
		...
		help: {
			...
			no_results_status: function no_results_status(keyword) {
				return __("<p>No results found for '" + keyword + "' in Help</p><p>Would you like to search <a class='switch-to-global-search text-muted' " + "style='text-decoration: underline;'>globally</a>" + " or the <a href='https://discuss.erpnext.com' class='forum-link text-muted' " + "style='text-decoration: underline;'>forums</a> instead?</p>");
			},
				...
				frappe.call({
					...
					callback: function callback(r) {
						if (r.message && r.message.title) {
							$result_modal.find('.modal-title').html("<span>" + r.message.title + "</span>");
